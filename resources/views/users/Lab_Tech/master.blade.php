    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
      <div class="app-brand demo">
        ...
        <span class="app-brand-logo demo">
          ...
          <span class="app-brand-text demo menu-text fw-bolder ms-2">Lab Technician DASHBOARD</span>
        </a>
      ...
      <ul class="menu-inner py-1 overflow-auto">
        ...
        <li class="menu-item active">
          <a href="#" class="menu-link">
            ...
            <div data-i18n="Analytics"> Lab technician Dashboard</div>
          </a>
        </li>
        <!-- Layouts -->
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <div data-i18n="Layouts">Lab Request</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route('la')}}" class="menu-link">
                <div data-i18n="Without menu">Requested Tests</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="#" class="menu-link">
                <div data-i18n="Without navbar">Lab result</div>
              </a>
            </li>
          </ul>
        </li>
