    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
      <div class="app-brand demo">
        ...
        <span class="app-brand-logo demo">
          ...
          <span class="app-brand-text demo menu-text fw-bolder ms-2">PHARMACIST DASHBOARD</span>
        </a>
      ...
      <ul class="menu-inner py-1 overflow-auto">
        ...
        <li class="menu-item active">
          <a href="# " class="menu-link">
            ...
            <div data-i18n="Analytics"> Pharmacist Dashboard</div>
          </a>
        </li>
        <!-- Layouts -->
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <div data-i18n="Layouts"> medication</div>
          </a>
          <ul class="menu-sub">
           
            <li class="menu-item">
              <a href="{{route('med')}}" class="menu-link">
                <div data-i18n="Without navbar">Medication order</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route ('disp') }} " class="menu-link">
                <div data-i18n="Without menu">Medication-dispence</div>
              </a>
            </li>
          </ul>
        </li>
      ...
      <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-layout"></i>
            <div data-i18n="Layouts"> medication List</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route ('list') }} " class="menu-link">
                <div data-i18n="Without menu"> Available Medicines</div>
              </a>
            </li>
            </ul>
    </aside>
