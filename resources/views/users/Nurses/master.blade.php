...
<head>
    ...
    <title>NURSES - @yield('title')</title>
    ...
    <div class="layout-container">
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
        <div class="app-brand demo">
          ...
          <span class="app-brand-text demo menu-text fw-bolder ms-2">NURSE</span>
        ...
        <ul class="menu-inner py-1 overflow-auto">
          ...
          <li class="menu-item active">
            <a href="#" class="menu-link">
              ...
              <div data-i18n="Analytics">NURSE Dashboard</div>
            </a>
          </li>
          <!-- Layouts -->
          ...
          <li class="menu-item ">
            ...
            <ul class="menu-sub" >
            <li class="menu-item">
                <a href="{{route('Npatients.list')}}" class="menu-link">
                  <div data-i18n="Without navbar">Patient List</div>
                </a>
              </li> 
              <li class="menu-item">
                <a href="{{ route('patient-detail') }}" class="menu-link">
                  <div data-i18n="Without menu">Assigned Patient</div>
                </a>
              </li>
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{route ('prescription') }}" class="menu-link">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block">Nurse</span>
